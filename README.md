...
# 📖 ENUM RUBY <a name="about-project"></a>

This project is a collaborative project that create a custom enumerable module.
...
sh
  cd my-folder
  git clone git@github.com:rica213/enum_ruby.git
...
- [ ] ** Add more methods into the module **
